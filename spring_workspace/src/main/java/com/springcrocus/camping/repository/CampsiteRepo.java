...
public interface CampsiteRepo extends JpaRepository<Campsite,Long>{
    ...
    List<Campsite> findByCampsiteNameContainsAndCampsiteLocalContainsAndCampingTypeTypeIndexContains(String campsiteName, String campsiteLocal, Long typeIndex);
